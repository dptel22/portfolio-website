...
html = re.sub(r'<article class="project-card">\s*<span class="card-number" aria-hidden="true">01</span>.*?</article>', aria_card, html, flags=re.DOTALL)
...
html = re.sub(r'<article class="project-card">\s*<span class="card-number" aria-hidden="true">02</span>.*?</article>', resolve_card, html, flags=re.DOTALL)
...
html = re.sub(r'<article class="project-card">\s*<span class="card-number" aria-hidden="true">03</span>.*?</article>', vitasakhi_card, html, flags=re.DOTALL)

# Delete Card 4
html = re.sub(r'<article class="project-card">\s*<span class="card-number" aria-hidden="true">04</span>.*?</article>', '', html, flags=re.DOTALL)
...
# Footer SVGs
github_svg = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>'
linkedin_svg = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>'

html = re.sub(r'<a href="https://github.com/dptel22" aria-label="GitHub" target="_blank" rel="noopener noreferrer">GH</a>', f'<a href="https://github.com/dptel22" aria-label="GitHub profile" target="_blank" rel="noopener noreferrer">{github_svg}</a>', html)
html = re.sub(r'<a href="https://www.linkedin.com/in/dhruv-patel-949946261/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">IN</a>', f'<a href="https://www.linkedin.com/in/dhruv-patel-949946261/" aria-label="LinkedIn profile" target="_blank" rel="noopener noreferrer">{linkedin_svg}</a>', html)
